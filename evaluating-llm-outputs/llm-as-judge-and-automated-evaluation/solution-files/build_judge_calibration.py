...
Produces `judge_calibration_examples.jsonl` next to the artifacts from an earlier lesson.
...
def main():
    parser = argparse.ArgumentParser(description="Write judge calibration examples.")
