...
Produces `judge_calibration_examples.jsonl` next to the lesson 1 artifacts.
...
def main():
    parser = argparse.ArgumentParser(description="Write judge calibration examples for lesson 2.")
